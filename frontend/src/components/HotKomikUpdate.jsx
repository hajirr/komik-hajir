...
const HotKomikUpdate = ({ hotKomikUpdate, isLoading }) => {
  ...
  return (
    <div className="p-2 border-solid border border-red-500 rounded-lg">
      <div className="font-semibold text-red-500 text-sm">HOT KOMIK UPDATE</div>
        ...
        {isLoading &&
          list.map((item) => {
            return (
              <div
                key={item}
                className="border border-red-300 shadow rounded-md p-4 max-w-sm w-full mx-auto"
              >
